...
export function SignupForm() {
  ...
  const handleGoogleSignUp = () => {
    setIsLoading(true)
    // Simulate Google sign-up (replace with actual OAuth)
    setTimeout(() => {
      localStorage.setItem("isAuthenticated", "true")
      router.push("/dashboard")
    }, 1000)
  ...
  return (
    <Card className="shadow-2xl bg-slate-900/80 backdrop-blur-xl border-slate-700/50">
      <CardHeader>
        ...
        <CardDescription className="text-gray-300">Sign up to start finding the perfect journals</CardDescription>
      </CardHeader>
      <CardContent>
